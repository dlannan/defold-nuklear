...
struct nk_image {nk_handle handle;unsigned short w,h;unsigned short region[4];int itype;};
 ...
 *
 * ============================================================================= */
NK_API void nk_tooltip(struct nk_context*, const char*, int align=0);
#ifdef NK_INCLUDE_STANDARD_VARARGS
...
#endif
NK_API int nk_tooltip_begin(struct nk_context*, float width, int align=0);
